...
public class QWithQueryTest {
    ...
    @Test
    public void testMysqlQwithQuerySubmission() throws Exception {
        QwithQuery qWithQuery = null;


        // Test QWith query execution
        squalParser.ReInit(new StringReader("{ SELECT * FROM A, B WHERE A.a > 1 OR B.f IS NULL}" +
